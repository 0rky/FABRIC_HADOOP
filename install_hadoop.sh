...
<configuration>
  ...
  <property>
      ...
      <value>file:/data/hadoop_data</value>
  </property>
  <property>
...
<configuration>
    ...
    <property>
      ...
      <value>/data/hadoop_data/namenode_data</value>
    </property>
    <property>
...
do
        ...
        then
                ...
                ssh -o "StrictHostKeyChecking no" $ip "cp /home/$USER/masters /data/hadoop/etc/hadoop/masters"
                i=$((i+1))
        else
